...
//   }
  ...
  $stmt = $connection->prepare("INSERT INTO training (cash, person, date, description) 
  VALUES (?, ?, ? ,?)");
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Training Expenditure
</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="card card-primary">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <?php
                  $q = mysqli_query($connection, "select * from training") or die(mysqli_error($connection));
          ...
          <a href="edit.php?id='.$row['id'].'&table=training&page=training.php" class="btn btn-info">
            <i class="fas fa-edit"></i>
          </a>
                  <button class="btn btn-danger" onclick="confirmDelete('.$row['id'].', \'training\')">
