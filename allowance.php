...
//   }
  ...
  $stmt = $connection->prepare("INSERT INTO allowance (cash, person, date, description) 
  VALUES (?, ?, ? ,?)");
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Field Allowance
</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Allowance Data</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<?php
$q = mysqli_query($connection, "select * from allowance") or die(mysqli_error($connection));
while($row = mysqli_fetch_array($q))
{
  ...
  echo '<td style="text-align:center">
          <a href="edit.php?id='.$row['id'].'&table=allowance&page=allowance.php" class="btn btn-info">
          <i class="fas fa-edit"></i>
        </a>
        <button class="btn btn-danger" onclick="confirmDelete('.$row['id'].', \'allowance\')">
        ...
        $.ajax({
          ...
          success: function(response) {
            if (response === 'success') {
              ...
              // Refresh the table
            window.location.replace("allowance.php");
            } else {
