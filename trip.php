...
//   }
  ...
  $stmt = $connection->prepare("INSERT INTO trip (cash, person, date, description) 
  VALUES (?, ?, ? ,?)");
      ...
      <div class="card card-primary">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <?php
                  $q = mysqli_query($connection, "select * from trip") or die(mysqli_error($connection));
          ...
          <a href="edit.php?id='.$row['id'].'&table=trip&page=trip.php" class="btn btn-info">
            <i class="fas fa-edit"></i>
          </a>
                  <button class="btn btn-danger" onclick="confirmDelete('.$row['id'].', \'trip\')">
